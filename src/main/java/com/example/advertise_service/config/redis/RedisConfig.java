package com.example.advertise_service.config.redis;
...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, List<AdvertisementSummaryResponse>> redisTemplate(
            RedisConnectionFactory factory) {
        RedisTemplate<String, List<AdvertisementSummaryResponse>> tpl = new RedisTemplate<>();
